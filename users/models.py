...
class Profile(models.Model): # Profile é uma classe que adiciona mais campos/dados ao User do Django, para os usuários bolsistas
    ...
    nome = models.CharField(max_length=150, null=True, blank=True, verbose_name='Nome') # null=True porque quando o usuário se registrar, cria-se automaticamente um objeto do tipo perfil ligado à esse usuário que ainda não preencheu o nome completo. Por isso, inicialmente, no banco de dados, o valor é nulo.
    sobrenome = models.CharField(max_length=150, null=True, blank=True, verbose_name='Sobrenome') # null=True porque quando o usuário se registrar, cria-se automaticamente um objeto do tipo perfil ligado à esse usuário que ainda não preencheu o nome completo. Por isso, inicialmente, no banco de dados, o valor é nulo.
    email = models.EmailField(max_length=254, null=True, blank=True, verbose_name='E-mail') # EmailField é um campo de email, que não pode ser maior que 254 caracteres
    nome_exibicao = models.CharField(max_length=50, null=True, blank=True, verbose_name='Nome de exibição') # Nome que será exibido no site, se não for preenchido, será o nome completo
    ...
    data_nascimento = models.DateField(null=True, blank=True, verbose_name='Data de nascimento') # dd/mm/aaaa (vamos usar uma máscara, para as /)
    cpf = models.CharField(max_length=14, null=True, blank=True, verbose_name='CPF') # xxx.xxx.xxx-xx (vamos usar uma máscara, para os . e -)
    rg = models.CharField(max_length=12, null=True, blank=True, verbose_name='RG') # xx.xxx.xxx-x (vamos usar uma máscara, para os . e -)
    telefone = models.CharField(max_length=19, null=True, blank=True, verbose_name='Número de Telefone') # (xx) xxxxx-xxxx (vamos usar uma máscara, para os () e -)
    genero = models.CharField(max_length=20, choices=Genders, null=True, blank=True, verbose_name='Gênero') # choices é uma tupla de tuplas, onde o primeiro elemento de cada tupla é o valor que será salvo no banco de dados e o segundo é o valor que será exibido no site (verbose_name é o nome que será exibido no site
    ...
    cor_ou_raca = models.CharField(max_length=20, choices=Race, null=True, blank=True, verbose_name='Cor ou Raça')
    ...
    ano_ingresso = models.CharField(max_length=4, null=True, blank=True, verbose_name='Ano de Ingresso')
    ano_formatura = models.CharField(max_length=4, null=True, blank=True, verbose_name='Ano de Formatura')
